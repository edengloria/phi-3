...
public class MainActivity extends AppCompatActivity implements GenAIWrapper.TokenUpdateListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tokenRateTV = findViewById(R.id.tokenRateTV);
        ...
        sendMsgIB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Initialize start time and token count here, before any interaction starts
    ...
    public void onTokenUpdate(String token) {
        runOnUiThread(() -> {
            ...
            if (elapsedTime > 0) {
                double tokensPerSecond = (tokenCount / (elapsedTime / 1000.0));
                tokenRateTV.setText(String.format(Locale.US, "Tokens/sec: %.2f", tokensPerSecond));
            }
